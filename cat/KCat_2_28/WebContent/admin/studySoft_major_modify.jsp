...
$(function(){
	...
	var major = decodeURI("<%=request.getParameter("major")%>");
	$("#major").val(major);
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$.post("${pageContext.request.contextPath}/updateMajor.do",{titleSName:$("#major").val(),id:id},function(data){
				if(data){
					parent.layer.msg('修改成功',{time: 500, icon: 1},function(){
						window.parent.location="${pageContext.request.contextPath}/admin/studySoft_major.jsp";
