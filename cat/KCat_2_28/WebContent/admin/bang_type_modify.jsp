...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$.post("${pageContext.request.contextPath}/updateBang_Type.do",{titleName:$("#type").val(),id:id},function(data){
				if(data){
					parent.layer.msg('修改成功',{time: 500, icon: 1},function(){
						window.parent.location="${pageContext.request.contextPath}/admin/bang_type.jsp";
