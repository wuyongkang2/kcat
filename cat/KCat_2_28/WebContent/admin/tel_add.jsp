...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$.post("${pageContext.request.contextPath}/addTel.do",{name:$("#name").val(),cid:$('#category option:selected').val(),category:$('#category option:selected').text(),images:time_name2,tel:$("#tel").val()},function(data){
				if(data){
