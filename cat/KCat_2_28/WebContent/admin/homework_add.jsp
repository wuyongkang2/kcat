...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$.post("${pageContext.request.contextPath}/addHomework.do",{cid:$('#category option:selected').val(),category:$('#category option:selected').text(),title:$("#title").val(),images:time_name2,link:$("#link").val(),pw:$('#pw').val()},function(data){
				if(data){
