...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 主页 <span class="c-gray en">&gt;</span> 内容管理 <span class="c-gray en">&gt;</span> 作业辅助 <span class="c-gray en">&gt;</span> banner管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
function soft_edit(object){
	...
	member_edit('编辑banner','homework_banner_modify.jsp?id='+id+'&jpg='+jpg+'','800','480');
}
/*软件-编辑*/
